    ...
    <section id="about" className="bg-newwinter-lightest">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <br/><br/>
          <b className="text-newwinter-darkest">I'm a Front End Developer </b> <br/><br/> Who enjoys creating and developing things from scratch, as well as bringing ideas to life in the digital world using Web development and UI/UX design.
          <br/>
          <br/>

...
export const posts = [
  {
    title: "איך עובד האלגוריתם של אינסטגרם",
    subtitle: "המאה ה-21",
    description:"נתחיל מזה שאין לאינסטגרם אלגוריתם אחד' יש להם מגוון של אלגוריתמים מיוחדים עבור כל אזור. החזון של אינסטגרם הוא לספק את חווית שימוש מקסימאלית בזמן הגלישה והיא משתמשת בטכנולוגיות שונות על מנת להתאים אישית לכל משתמש את חווית הגלישה שלו",
    image: "./instagramAlgo.jpg",
    link: "/",
  },
];
